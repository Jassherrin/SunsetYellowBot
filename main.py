...
chanceBall = [
    ...
    'Without a doubt', 'Yes', 'No', 'Yes, definitely.', 'You may rely on it',
    'The Whole World is screaming Yes!', 'YAS QUEEN!',
...
def anime(message):
    bot.reply_to(message,
                 "Find anime to watch: https://myanimelist.net/ \n\n ")
